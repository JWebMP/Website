...
public class RenderingPage extends WebsitePage<RenderingPage> implements INgComponent<RenderingPage> {
    public RenderingPage() {
        ...
        grid.add(featureCard("Dual-Mode Output", "toString(true) renders full HTML with all CSS/JS assets for hosted mode. toString() renders JSON for AJAX responses. Same component tree, two formats.", null));
