...
/**
 * Base class for individual framework component pages.
 * Each concrete subclass has its own @NgRoutable path like
 * {@code frameworks/web-awesome/wa-button}.
 */
public abstract class FrameworkComponentPage<J extends FrameworkComponentPage<J>> extends WebsitePage<J> implements INgComponent<J>
{
    private static final String QUIET = "quiet";

    protected FrameworkComponentPage(String frameworkId, String frameworkName, PluginEntry.ComponentInfo component)
    {
        ...
        // Back link
        layout.add(buildCta("← Back to " + frameworkName, "/frameworks/" + frameworkId, Variant.Neutral, Appearance.Plain));
